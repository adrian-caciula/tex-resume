...
\item \begin{tabular1bold} Microsoft, Engineer; Seattle, WA & 2015 -- Present \end{tabular1bold}
  ...
  \item BitFunnel search engine. Near order of magnitude throughput/cost improvement \hfill \emph{C++}
    ...
    \begin{list3}
      \item Found and fixed individual bugs each worth 7-figures per year
      \item Replaced largest and most complicated part of the system with 30LOC; 2x performance improvement
    \end{list3}
  \end{list2}
